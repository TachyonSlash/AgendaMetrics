...
var createUser = function (userData) { return __awaiter(void 0, void 0, void 0, function () {
    var username, email, password, error, saltRounds, passwordHash, newUser, savedUser;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                username = userData.username, email = userData.email, password = userData.password;
                if (!password || password.length < 6) {
                    error = new Error('La contrasela es obligatoria y debe tener al menos 6 caracteres');
